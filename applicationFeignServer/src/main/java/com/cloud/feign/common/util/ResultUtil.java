package com.cloud.feign.common.util;

import com.cloud.feign.common.entity.AjaxResult;
import com.cloud.feign.common.enums.ResultCodeEnum;
...
public class ResultUtil {
	...
	public static AjaxResult serverError(){
		return AjaxResult.builder().code(ResultCodeEnum.SERVER_ERROR.getValue()).msg("服务维护中...").build();
	}
}
